...
fn MakePrintable(comptime BaseType: type) type {
    return struct {
        // you CANNOT use an inferred error set. It will cause the compiler to crash.
        pub inline fn to_string(self: BaseType, a: std.mem.Allocator) std.fmt.AllocPrintError![]u8 {
...
const SubType = struct {
    ...
    pub fn to_string(self: *@This(), a: std.mem.Allocator) std.fmt.AllocPrintError![]u8 {
